...
namespace Dos.Tools
{
    public class EntityBuilder
    {
        ...
        public string Builder(string tplContent, string BusinessName = "", string keyName = "")
        {
            ...
            if (!string.IsNullOrWhiteSpace(tplContent))
            {
                ...
                var primarykeyColumns = CsColumns.FindAll(col => col.IsPK);
                var identityColumn = CsColumns.Find(col => col.IsIdentity);
    ...
    public class DbToCS
    {
        ...
        public static List<Model.ColumnInfo> DbtoCSColumns(List<Model.ColumnInfo> columns, string dbType)
        {
            ...
            List<ColumnInfo> copyColumns = columns.Select(item => Utils.Clone(item)).ToList();
            foreach (ColumnInfo column in copyColumns)
            {
                try
                {
